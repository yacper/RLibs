...
public class SerializerTest
{
    ...
    public static List<Bar> LBars2 = new List<Bar>
    {
        new Bar() { Time = DateTime.Parse("2021/07/01"), Open = 1800, High = 1815, Low = 1755, Close = 1810, Volume = 100 },
        new Bar() { Time = DateTime.Parse("2021/07/02"), Open = 1820, High = 1835, Low = 1775, Close = 1830, Volume = 200 },
        new Bar() { Time = DateTime.Parse("2021/07/03"), Open = 1830, High = 1855, Low = 1795, Close = 1840, Volume = 300 },
    };
    ...
    {
        LBars.ToExcel("bars.xls", "bars1");
        LBars.ToExcel("bars.xls", "bars2");
        LBars2.ToExcel("bars.xls", "bars2");

        var lbas = "bars.xls".FromExcel<Bar>("bars1");
        var lbas2 = "bars.xls".FromExcel<Bar>("bars2");
