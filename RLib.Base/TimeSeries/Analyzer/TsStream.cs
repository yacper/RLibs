...
namespace RLib.Base
{
//    public class TsStream<T, T2> :  TimeSeries<T, T2>, ITsStream<T, T2> where T:ITimeValue<T2> 
//    {
//#region Overrides
//        public override string ToString() { return m_strName; }
//#endregion
...
//#region C&D
//        public TsStream(int timeFrame = 0, int first = 0,
